...
def apply_transforms_and_split(datasets, target):
    ...
    Args:
        datasets: Um dicionário onde a chave é o nome do DataFrame e o valor é o DataFrame.
    ...
    for name, dataset in datasets.items():  # Itera sobre os itens do dicionário
        ...
        df_splits_and_transformed[name] = (X_train, X_test, y_train, y_test)  # Usa o nome como chave no dicionário

    return df_splits_and_transformed

datasets_transformed = apply_transforms_and_split(datasets, 'target')